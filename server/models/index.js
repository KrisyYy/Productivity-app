...
db.taskparticipants = TaskParticipants;
db.taskparticipants = db.users.belongsToMany(db.tasks, { through: TaskParticipants, foreignKey: "user_id" });
...
db.taskcategories = TaskCategories;
